...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    ru: {
      ...
      heroText:
        "JWS Group ведёт таможенное декларирование, принимает грузы на собственный склад временного хранения (СВХ) и сопровождает поставки от границы до получателя.",
      ...
      service4Title:
        "Определение кода ТН ВЭД и ставок",
      ...
      processTitle:
        "Путь груза от заявки до выдачи",
      ...
      about1Text:
        "Подготовка комплекта документов для таможенной декларации и сопровождение проверки.",

      about2:
        "СВХ",

      about2Text:
        "Приём, хранение и выдача груза на складе временного хранения.",

      about3:
        "Таможня",

      about3Text:
        "Взаимодействие с таможенными органами и оформление выпуска.",

      about4:
        "Выдача груза",

      about4Text:
        "Передача груза получателю или организация доставки.",
    ...
    kz: {
      ...
      heroText:
        "JWS Group кедендік декларациялауды жүргізеді, жүктерді уақытша сақтау қоймасына қабылдайды және шекарадан алушыға дейін сүйемелдейді.",
      ...
      service4Title:
        "ТН ВЭД кодын және мөлшерлемелерді анықтау",
      ...
      processTitle:
        "Өтінімнен жүк берілгенге дейін",
      ...
      about1Text:
        "Кедендік декларация үшін құжаттар пакетін дайындау және тексеруді сүйемелдеу.",

      about2:
        "СВХ",

      about2Text:
        "Уақытша сақтау қоймасында жүкті қабылдау, сақтау және беру.",

      about3:
        "Кеден",

      about3Text:
        "Кеден органдарымен жұмыс және жүкті шығаруды рәсімдеу.",

      about4:
        "Жүкті беру",

      about4Text:
        "Жүкті алушыға беру немесе жеткізуді ұйымдастыру.",
    ...
    en: {
      ...
      service4Title:
        "HS code and duty rate determination",
      ...
      about1Text:
        "Preparation of documents for customs declaration and support during verification.",

      about2:
        "Storage",

      about2Text:
        "Cargo reception, storage and release at the temporary storage warehouse.",

      about3:
        "Customs",

      about3Text:
        "Communication with customs authorities and cargo release procedures.",

      about4:
        "Cargo release",

      about4Text:
        "Cargo handover to the recipient or delivery arrangement.",
  ...
  const savedLanguage =
    localStorage.getItem("jws-language");
  ...
  function calculate() {
    ...
    const dutyRate =
      numberValue(dutyInput);

    const vatRate =
      numberValue(vatInput);

    const weight =
      numberValue(weightInput);

    const volume =
      numberValue(volumeInput);
    ...
    */
    ...
    /*
      НДС рассчитывается
      от таможенной стоимости + пошлины.
    */
    ...
    contactForm.addEventListener(
      ...
      async (event) => {
        ...
        */
        ...
        /*
          Если Formspree подключён,
          используем стандартную отправку.
        */
